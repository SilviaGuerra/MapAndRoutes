    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="25.683" height="89.637" viewBox="0 0 25.683 89.637">
        <g id="Grupo_1397" dataName="Grupo 1397" fill={props.color} >
            ...
            <g id="Grupo_1327" dataName="Grupo 1327" transform="rotate(-90 16.613 7.197)">
                ...
                <circle id="Elipse_287" cx="2.101" cy="2.101" r="2.101" class="cls-2" dataName="Elipse 287" transform="translate(7.003 1.401)" />
                <circle id="Elipse_288" cx=".7" cy=".7" r=".7" dataName="Elipse 288" transform="translate(0 2.801)" opacity= ".809" />
            </g>
            <g id="Grupo_1328" dataName="Grupo 1328" transform="rotate(-90 49.526 40.111)">
                <circle id="Elipse_289" cx="3.501" cy="3.501" r="3.501" class="cls-1" dataName="Elipse 289" transform="rotate(180 3.502 3.502)" />
                <circle id="Elipse_290" cx="2.101" cy="2.101" r="2.101" class="cls-3" dataName="Elipse 290" transform="rotate(180 8.403 2.801)" />
                <circle id="Elipse_291" cx=".7" cy=".7" r=".7" class="cls-3" dataName="Elipse 291" transform="rotate(180 11.905 2.101)" />
            </g>
        </g>
    </svg>
);
